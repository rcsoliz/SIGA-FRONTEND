...
<template>
  <div
    :class="cn(
      'border-border/50 bg-background gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs shadow-xl grid min-w-40 items-start',
      props.class,
    )"
  >
    <slot>
      ...
      <div class="grid gap-1.5">
        ...
        >
          ...
          <div :class="cn('flex flex-1 justify-between gap-3 leading-none', nestLabel ? 'items-end' : 'items-center')">
            <div class="grid gap-1.5">
